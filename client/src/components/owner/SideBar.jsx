    ...
    return (
        <div className='relative min-h-screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
            <div className='group relative'>
                <label htmlFor="image">
                    <img src={image ? URL.createObjectURL(image) : user?.image || "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png"} className='h-9 md:h-14 w-9 md:w-14 rounded-full mx-auto' alt="" />
                    <input type="file" name="image" id="image" accept='image/*' hidden onChange={e => setImage(e.target.files[0])} />
